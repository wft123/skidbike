...
/*
 * SpeedActivity에서 현재 속도를 표현하는 그래프의 클래스 파일입니다.
 * SpeedChangeListener를 상속받아 속도의 변화를 표현합니다.
 * OpenSource이기 때문에 현재 클래스에서 다양한 값 변화를 통해
 * 커스텀화 가능합니다.
 */
...
public class Speedometer extends View implements SpeedChangeListener {
	...
	public static final float DEFAULT_MAX_SPEED = 60; // Assuming this is km/h and you drive a super-car
	...
	private float READING_SIZE = 160f;
...
//		Log.d(TAG, "Height spec: " + MeasureSpec.toString(heightMeasureSpec));
	...
	private void drawReading(Canvas canvas){
		Path path = new Path();
		String message = String.format("%.2f", this.mCurrentSpeed);
